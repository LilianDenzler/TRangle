...
cmd.load("outputs/2cdf/2cdf_oriented.pdb","input_2cdf_oriented")
cmd.load("outputs/2cdf/consensus_oriented.pdb","cons_2cdf_oriented")
cmd.bg_color("white")
...
cmd.zoom("all")
cmd.png("outputs/2cdf/vis/2cdf_vis.png", dpi=300)
cmd.save("outputs/2cdf/vis/2cdf_vis.pse")
cmd.quit()
