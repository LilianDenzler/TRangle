...
cmd.load("/workspaces/Graphormer/TRangle/trangle/testout/vis/aligned_input.pdb","input_aligned_input")
cmd.load("/workspaces/Graphormer/TRangle/trangle/testout/vis/consA.pdb","consA_aligned_input")
cmd.load("/workspaces/Graphormer/TRangle/trangle/testout/vis/consB.pdb","consB_aligned_input")
cmd.bg_color("white")
...
cmd.zoom("all")
cmd.png("testout/vis/vis.png", dpi=300)
cmd.save("testout/vis/vis.pse")
cmd.quit()
